...
public class FruitEditor {
	...
	private void fileToolSetup() {
		// FILE BUTTONS
		newBtn 		= makeButton("N", "images/newfile.png",
				"New", "newBtn");
		openBtn 	= makeButton("O", "images/openfile.png",
				"Open", "openBtn");
		saveBtn		= makeButton("S", "images/savefile.png",
				"Save", "saveBtn");
	...
	private void editToolSetup() {
		...
		deleteBtn	= makeButton("X", "images/delete.png", 
	...
	private void fixToolSetup() {
		// EDIT -> FIX BUTTONS
		undoBtn		= makeButton("U", "images/undo.png", 
									"Undo", "undoBtn");		// EDIT -> FIX -> UNDO
		redoBtn		= makeButton("R", "images/redo.png", 
